...
fn version_string() -> &'static str {
    ...
    STRING.get_or_init(|| format!("(release {MQTT_CLIENT_VERSION}) (rustc {RUSTC_VERSION})"))
}

static MQTT_CLIENT_VERSION: &str = env!("MQTT_CLIENT_VERSION");
static RUSTC_VERSION: &str = env!("MQTT_CLIENT_RUSTC_VERSION");
